    ...
    try {
      ...
      if (error is DioException) {
        Helper.warningSnackBar(
            title: 'getProfileSavingsPortfolios DioException',
  ...
  */
  ...
  Future<List<Profile>?> getProfiles() async {
    ...
    try {
      ...
      if (error is DioException) {
        Helper.warningSnackBar(
            title: 'getProfiles DioException',
            message: error.response.toString(),
            duration: 5);
      }
      return profiles;
  ...
  Future<Map<String, dynamic>?> getAcceptedMemberProfileByID(String id) async {
    ...
    try {
      ...
      if (error is DioException) {
        Helper.warningSnackBar(
            title: 'getAcceptedMemberProfileByID DioException',
            message: error.response.toString(),
            duration: 5);
      }
      return null;
  ...
  Future<Map<String, dynamic>?> getMemberProfileByID(String id) async {
    ...
    try {
      ...
      if (error is DioException) {
        Helper.warningSnackBar(
            title: 'getMemberProfileByID DioException',
            message: error.response.toString(),
            duration: 5);
      }
      return null;
  ...
  Future<List<Profile>?> filterProfiles(String query) async {
    ...
    try {
      ...
      if (error is DioException) {
        Helper.warningSnackBar(
            title: 'filterProfiles DioException',
            message: error.response.toString(),
            duration: 5);
      }
      return profiles;
      ...
      if (_getStorage.read('userId') != null) {
        ...
        await supabase
            ...
            .catchError((error) {
              ...
              if (error is DioException) {
                Helper.warningSnackBar(
                    title: 'updateProfile DioException',
                    message: error.response.toString(),
                    duration: 5);
              }
              if (error is PostgrestException) {
  ...
  Future<Profile?> updateMemberRequest(String? request_id, status) async {
    ...
    if (request_id != null) {
      try {
        ...
        if (error is DioException) {
          Helper.warningSnackBar(
              title: 'updateMemberRequest DioException',
              message: error.response.toString(),
              duration: 5);
        }
        Helper.errorSnackBar(
  ...
  getCloudImage() async {
    try {
      ...
      if (error is DioException) {
        Helper.warningSnackBar(
            title: 'getCloudImage DioException',
            message: error.response.toString(),
            duration: 5);
      }
      if (error is PostgrestException) {
