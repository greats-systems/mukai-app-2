...
const String tIdNumber = "ID NUmber";
...
const String tCongratulations = "successful";
...
// -- On Boarding Text
const String tOnBoardingTitle1 = "Buy and pocket your change.";
const String tOnBoardingTitle2 = "Share and spend your change with friends";
const String tOnBoardingTitle3 = "Do more with your change";
const String tOnBoardingSubTitle1 = "Do not lose any coin, safe guard it";
const String tOnBoardingSubTitle2 =
    "Round up your change and get the fun going ";
const String tOnBoardingSubTitle3 =
    "Buy directly with your change at zero cost.";
...
const String tWelcomeTitle =
    "Buy and get your change accumulating on every transaction, anytime.";
const String tWelcomeSubTitle =
    "Create your account today and let the your pocket grow, Stop losing money.";

// -- Login Screen Text
const String tLoginTitle = "Got Access?";
const String tLoginSubTitle = "Signin, Buy and Save.";
...
const String tSignUpSubTitle = "Create your profile, save every coin.";
...
const String loyaltyDashboardHeading = "Explore Loyalty Programs";
